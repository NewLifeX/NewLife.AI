...
public partial class ChatMessage : Entity<ChatMessage>
{
    ...
    //    if (XTrace.Debug) XTrace.WriteLine("开始初始化ChatMessage[对话消息]数据……");
    ...
    //    entity.ParentMessageId = 0;
    //    entity.Attachments = "abc";
    //    entity.Insert();

    //    if (XTrace.Debug) XTrace.WriteLine("完成初始化ChatMessage[对话消息]数据！");
    //}
