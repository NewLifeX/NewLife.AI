...
public class PresetsControllerTests
{
    ...
    {
        var dto = new PresetDto(1, "代码审查", 10, "GPT-4o", "review", "你是代码审查员", 1, true, 100);
    ...
    {
        var dto = new PresetDto(2, "简单预设", 0, null, null, null, 0, false, 0);
    ...
    {
        var dto1 = new PresetDto(1, "测试", 0, null, null, null, 0, false, 0);
        var dto2 = new PresetDto(1, "测试", 0, null, null, null, 0, false, 0);
    ...
    public void PresetDto_ThinkingMode_MapsCorrectly()
    {
        ...
        var auto = new PresetDto(1, "自动", 0, null, null, null, (Int32)ThinkingMode.Auto, false, 0);
        var think = new PresetDto(2, "思考", 0, null, null, null, (Int32)ThinkingMode.Think, false, 0);
        var fast = new PresetDto(3, "快速", 0, null, null, null, (Int32)ThinkingMode.Fast, false, 0);
