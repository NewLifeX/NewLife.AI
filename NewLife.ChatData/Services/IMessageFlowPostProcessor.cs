...
/// </para>
/// <para>
/// 对比 <see cref="IContextEnricher"/>：Enricher 发生在生成**前**、PostProcessor 发生在生成**后**。
/// 需要同时介入前后两端的业务应实现**两个**接口。
/// </para>
/// </remarks>
public interface IMessageFlowPostProcessor
{
    ...
    Task ProcessAsync(MessageFlowContext context, CancellationToken cancellationToken);
}
