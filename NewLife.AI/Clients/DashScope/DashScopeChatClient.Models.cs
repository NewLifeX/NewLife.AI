...
[AiClientModel("qwen-tts", "千问 TTS", Speech = true, FunctionCalling = false, InputPrice = 0.2)]
...
[AiClientModel("qwen3-tts-vd", "千问3 TTS VD", Speech = true, FunctionCalling = false, InputPrice = 0.2)]
[AiClientModel("qwen3-tts-vc", "千问3 TTS VC", Speech = true, FunctionCalling = false, InputPrice = 0.2)]
// Qwen-TTS-Realtime WebSocket 实时合成（稳定版别名）
[AiClientModel("qwen-tts-realtime", "千问 TTS Realtime", Speech = true, FunctionCalling = false, InputPrice = 0.2)]
...
[AiClientModel("qwen3-tts-vd-realtime", "千问3 TTS VD Realtime", Speech = true, FunctionCalling = false, InputPrice = 0.2)]
[AiClientModel("qwen3-tts-vc-realtime", "千问3 TTS VC Realtime", Speech = true, FunctionCalling = false, InputPrice = 0.2)]
