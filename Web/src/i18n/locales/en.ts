export default {
  ...
  learning: {
    title: 'Self-Learning',
    loadError: 'Failed to load learning data',
    section: {
      memories: 'Memories',
      profile: 'Profile',
      tags: 'Tags',
    },
    memoriesDesc: 'Memories automatically extracted by AI from conversations for personalized replies.',
    profileDesc: 'User profile summary generated from conversation analysis.',
    tagsDesc: 'User attribute tags automatically labeled by AI. Higher weight means more prominent.',
    noMemories: 'No memories yet. AI will start learning after you have more conversations.',
    noProfile: 'Profile not yet generated. Have more conversations to trigger analysis.',
    noTags: 'No tags yet.',
    active: 'Active',
    inactive: 'Inactive',
